...
app.use(
    ...
    >({
        ...
        messages: {
            en_us,
            zh_cn: zh_cn as unknown as MessageSchema,
            zh_tw: zh_tw as unknown as MessageSchema,
            ja_jp: ja_jp as unknown as MessageSchema,
            ko_kr: ko_kr as unknown as MessageSchema,
            de_de: de_de as unknown as MessageSchema,
            fr_fr: fr_fr as unknown as MessageSchema,
            es_es: es_es as unknown as MessageSchema,
            pt_br: pt_br as unknown as MessageSchema,
            ru_ru: ru_ru as unknown as MessageSchema,
            tr_tr: tr_tr as unknown as MessageSchema,
            pl_pl: pl_pl as unknown as MessageSchema,
        },
    }),
)
