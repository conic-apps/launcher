export default {
    ...
    settings: {
        ...
        about: {
            ...
            sponsorDesc:
                "Amethyst Launcher is a free, open-source, cross-platform Minecraft launcher. The program is built by OakChaser and other contributors. Your support will help us.",
            thanks: "Thanks",
