...
export default {
    ...
    update: {
        ...
        newVersion: "A new version is available: {version}",
        upToDate: "You are up to date",
        downloading: "Downloading update...",
        downloadedOf: "{downloaded} / {total}",
        installing: "Installing and restarting the launcher...",
        later: "Later",
        install: "Update Now",
        cancel: "Cancel",
        recheck: "Check Again",
    ...
    settings: {
        ...
        game: {
            ...
            addJavaDesc: "Download and install a new java runtime.",
            ...
            enterWorldAfterLaunch: "Enter world after launch",
            enterWorldAfterLaunchDesc: "Game version should not below 1.21",
            enterWorldAfterLaunchPlaceholder: "The name of the world folder.",
            ...
            autoRefreshAccountDesc:
                'If the login credentials expire, the launcher will refresh the login before starting the game. This way, if an "Invalid Session" error occurs, you only need to restart the game instead of restarting the launcher.',
        ...
        about: {
            ...
            viewSourceCodeDesc: "View source code in our GitHub repository.",
            sponsorDesc:
                "Conic Launcher is a free project that aims to bring a better gaming experience and help reduce carbon emissions. The project is developed and maintained by the developers of ConicMC. Your sponsorship or contribution can not only help Conic Launcher grow, but also contribute to the free software movement and environmental protection.",
            thanks: "Thanks",
