    ...
    <ScrollView>
      ...
      <div class="details" v-else-if="projectInfo">
        ...
        <div class="actions-section">
          <button
            class="heart"
            :class="{ 'heart-favorited': isFavorited('modrinth', 'pack', String(projectId)) }"
            @click="toggleFavorite('modrinth', 'pack', String(projectId))">
            <AppIcon
              :name="
                isFavorited('modrinth', 'pack', String(projectId)) ? 'heart' : 'heart-outline'
              "></AppIcon>
          </button>
