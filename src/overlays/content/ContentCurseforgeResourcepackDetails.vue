...
<template>
  <div class="content-curseforge-resourcepack-details">
    <ScrollView>
      <div class="title">
        <AppIcon name="extension-puzzle"></AppIcon>
        <p>{{ t("overlays.content.common.resourcePackInfo") }}</p>
      </div>
      ...
      <div class="details" v-else-if="modInfo">
        ...
        <div class="actions-section">
          <button
            class="heart"
            :class="{
              'heart-favorited': isFavorited('curseforge', 'resourcepack', String(modId)),
            }"
            @click="toggleFavorite('curseforge', 'resourcepack', String(modId))">
            <AppIcon
              :name="
                isFavorited('curseforge', 'resourcepack', String(modId)) ? 'heart' : 'heart-outline'
              "></AppIcon>
          </button>
...
.content-curseforge-resourcepack-details {
