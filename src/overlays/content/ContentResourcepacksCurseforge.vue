        ...
        <div
          ...
          <div class="actions" @click.stop>
            <button
              class="heart"
              :class="{
                'heart-favorited': isFavorited('curseforge', 'resourcepack', String(mod.id)),
              }"
              @click.stop="toggleFavorite('curseforge', 'resourcepack', String(mod.id))">
              <AppIcon
                :name="
                  isFavorited('curseforge', 'resourcepack', String(mod.id))
                    ? 'heart'
                    : 'heart-outline'
                "
                :size="14"></AppIcon>
...
function filterByFavorites(
  ...
  return {
    ...result,
    data: result.data.filter((mod) => isFavorited("curseforge", "resourcepack", String(mod.id))),
  };
}
