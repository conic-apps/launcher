...
<template>
  <div class="content-screenshots">
    <button
      class="close"
      @click="close"
      :title="t('overlays.content.screenshots.close')"
      ref="closeButton">
    ...
    <div class="main">
      <template v-if="screenshotSrcs.length === 0">
        <p class="empty">
          {{
            screenshots === null
              ? t("overlays.content.screenshots.loading")
              : t("overlays.content.screenshots.empty")
          }}
        </p>
      </template>
      <template v-else>
        <button
          ...
          :title="t('overlays.content.screenshots.prev')"
          ref="prevButton">
        ...
        <button
          ...
          :title="t('overlays.content.screenshots.next')"
          ref="nextButton">
          <AppIcon name="chevron-forward" :size="22"></AppIcon>
        </button>
      </template>
