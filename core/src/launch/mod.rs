...
fn spawn_minecraft_process(
    ...
    commands.push_str("# This file is automatically generated by Amethyst Launcher.\n");
    commands.push_str("# NOTE: Don't use this file to launch game.\n\n");
    ...
    if platform.os_type == OsType::Windows {
        commands.push_str(" -c "); // FIXME: on windows
    } else {
    ...
    let script_path = match platform.os_type {
        ...
        OsType::Windows => instance_root.join(".cache").join("launch.ps"),
    };
