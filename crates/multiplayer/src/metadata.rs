...
pub(crate) static LIBRARY: LibraryInfo = LibraryInfo {
    ...
    size: 6878208,
    sources: &[
        "https://dl.conicmc.app/nexus/v0.1.0-dcfd183/conic_nexus_aarch64-pc-windows-msvc.dll",
...
pub(crate) static LIBRARY: LibraryInfo = LibraryInfo {
    ...
    size: 8448512,
    sources: &[
        "https://dl.conicmc.app/nexus/v0.1.0-dcfd183/conic_nexus_x86_64-pc-windows-msvc.dll",
...
pub(crate) static LIBRARY: LibraryInfo = LibraryInfo {
    ...
    size: 9552592,
    sources: &[
        "https://dl.conicmc.app/nexus/v0.1.0-dcfd183/libconic_nexus_aarch64-unknown-linux-gnu.so",
...
pub(crate) static LIBRARY: LibraryInfo = LibraryInfo {
    ...
    size: 12006064,
    sources: &[
        "https://dl.conicmc.app/nexus/v0.1.0-dcfd183/libconic_nexus_x86_64-unknown-linux-gnu.so",
...
pub(crate) static LIBRARY: LibraryInfo = LibraryInfo {
    ...
    size: 6802944,
    sources: &[
        "https://dl.conicmc.app/nexus/v0.1.0-dcfd183/libconic_nexus_aarch64-apple-darwin.dylib",
...
pub(crate) static LIBRARY: LibraryInfo = LibraryInfo {
    ...
    size: 8849728,
    sources: &[
        "https://dl.conicmc.app/nexus/v0.1.0-dcfd183/libconic_nexus_x86_64-apple-darwin.dylib",
