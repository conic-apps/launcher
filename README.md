...
[![Magical Launcher Auto Build](https://github.com/OakChaser/magical-launcher/actions/workflows/build.yml/badge.svg)](https://github.com/OakChaser/magical-launcher/actions/workflows/build.yml)
...
```bash
git clone https://github.com/OakChaser/magical-launcher.git
cd magical-launcher
```
