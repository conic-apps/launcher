...
[![Amethyst Launcher Auto Build](https://github.com/OakChaser/amethyst-launcher/actions/workflows/build.yml/badge.svg)](https://github.com/OakChaser/amethyst-launcher/actions/workflows/build.yml)
...
```bash
git clone https://github.com/OakChaser/amethyst-launcher.git
