...
// return "".to_string();
// if !fs::metadata("/home/OakChaser/桌面/mc2/magical-launcher/test/test.json").is_ok() {
//     fs::File::create("/home/OakChaser/桌面/mc2/magical-launcher/test/test.json").unwrap();
//     return "".to_string();
// }
// fs::read_to_string("/home/OakChaser/桌面/mc2/magical-launcher/test/test.json").unwrap()
// }
